...
void windowSizeCallback(sf::Window &, int width, int height) {
...
int main() {
    ...
    sf::Window window(sf::VideoMode(800, 600, 32), "Models", sf::Style::Titlebar | sf::Style::Close, settings);
    defer(window.close());
    ...
    while(window.isOpen()) {
        ...
        glm::mat4 towerMVP = vp * glm::rotate(islandAngle, glm::vec3(0.0f, 1.0f, 0.0f)) * glm::translate(glm::vec3(-1.5f, -1.0f, -1.5f));
        ...
        glm::mat4 grassMVP = vp * glm::rotate(islandAngle, glm::vec3(0.0f, 1.0f, 0.0f)) * glm::translate(glm::vec3(0.0f, -1.0f, 0.0f));
        ...
        glm::mat4 skyboxMatrix = glm::translate(cameraPos) * glm::scale(glm::vec3(100.0f,100.0f,100.0f));
